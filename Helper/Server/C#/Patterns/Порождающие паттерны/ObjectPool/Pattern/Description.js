...
//пул создаст новый объект, а если объект не заблокирован ни одним из потоков, пул вернет этот объект и удалит его из портфеля.
//После того, как произошла работа с объектом, он записуется в портфель(портфель оптимизирован на вставку и удалени). при следующем обращение 
//к портфелю, он будет доставать и следом удалять существующий объект, если он доступен
